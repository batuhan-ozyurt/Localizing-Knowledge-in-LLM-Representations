#torchrun --nproc_per_node 2 script-prompting-llama13B.py --ckpt_dir $/userfiles/bozyurt20/llama/llama_weights/13B --tokenizer_path $/userfiles/bozyurt20/llama/llama_weights/tokenizer.model
...
def main(
    ...
    all_result_objects = predictor(model_instance, temperature=temerature, top_p=top_p)
