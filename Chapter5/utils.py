...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        model_kwargs["entity_hidden_states"] = entity_hidden_states
        model_kwargs["entity_inds"] = entity_inds
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            #print("llama generation happening.")
            model_inputs = self.prepare_inputs_for_generation(input_ids, **model_kwargs) #model_kwargs'ta ehs var. model_inputs'ta da var.
            ...
            next_token_logits = outputs.logits[:, -1, :] # B, T, Va
