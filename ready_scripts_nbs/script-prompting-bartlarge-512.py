    ...
    for item in dir_list_annotations:
        ...
        for line in annotations:
            ...
            for k in range(1, num_templates+1):
                ...
                prompt, context2 = create_prompt_clipped(tokenizer, k, text, character, grammatical_number, 497)
                ...
                with torch.no_grad():
                    summary_ids = model.generate(input_ids, num_beams=3, min_length=0, max_length=512)
...
with open("/kuacc/users/bozyurt20/hpc_run/predictions/bart_large_512_predictions.txt", "wb") as f:
