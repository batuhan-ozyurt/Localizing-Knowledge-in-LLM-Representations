#torchrun --nproc_per_node 1 /kuacc/users/bozyurt20/hpc_run/ready_scripts_nbs/script-prompting-llama7B.py --ckpt_dir $/userfiles/bozyurt20/llama/llama_weights/7B --tokenizer_path $/userfiles/bozyurt20/llama/llama_weights/tokenizer.model
...
def main(
    ...
    with open("llama_7B_predictions.txt", "wb") as f:
