...
def predictor(text_injection_instance, write_in_file=False, out_path_prefix="Text_injection_flan_ul2_"):
    ...
    for item in dir_list_annotations:
        ...
        while i < len(annotations) and j < no_paragraphs:
            ...
            if char_count + 2 >= annotations[i][0]:
                ...
                for k in [13]: #range(1, num_templates+1):
                    ...
                    for num_chap2_tokens in tokens_to_append:
                        ...
                        context = text + "\n" + chapter2_part
                        prompt, context = create_prompt_clipped(tokenizer, k, context, character, grammatical_number, 2048)
...
predictions, all_result_objects = predictor(text_injection_instance, write_in_file=False, out_path_prefix="Text_injection_flan_ul2_")

with open("Text_injection_flan_ul2_predictions.txt", "wb") as f:
    pickle.dump(predictions, f)
    
with open("Text_injection_flan_ul2_all_result_objects.txt", "wb") as f:
